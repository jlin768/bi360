...
class Diff{
   ...
   *                defaults to '<br>'
   */
  public static function toTable($diff,$firstFile,$secondFile, $indentation = '', $separator = '<br>'){

    // initialise the HTML
    $html = $indentation . "<table class=\"diff\">\n";
	$html = $html . "<thead><tr><th id='firstFile' style='padding-left:10px;'>".$firstFile."</th>\n<th id='secondFile' style='padding-left:10px;'>".$secondFile."</th>\n</tr></thead>";
    // loop over the lines in the diff
    $index = 0;
