...
BEGIN TRANSACTION
		insert into [VCI-Intranet].[dbo].[BI360_Change_History] 
					...
					values('newdata','changelog',(select Version from [OSRR4-G1].[dbo].Models),(select Data from [OSRR4-G1].[dbo].Models),(select Id from [OSRR4-G1].[dbo].Models),(select Version from [OSRR4-G2].[dbo].Models),(select Data from [OSRR4-G2].[dbo].Models),(select Id from [OSRR4-G2].[dbo].Models));
		insert into [VCI-Intranet].[dbo].[BI360_Change_History] 
					([New_Data],[ChangeLog],[Old_Version_G1],[Old_Data_G1],[Old_Id_G1],[Old_Version_G2],[Old_Data_G2],[Old_Id_G2]) 
					values('newdata','changelog',(select Version from [OSRR4-G1].[dbo].Models),(select Data from [OSRR4-G1].[dbo].Models),(select Id from [OSRR4-G1].[dbo].Models),(select Version from [OSRR4-G2].[dbo].Models),(select Data from [OSRR4-G2].[dbo].Models),(select Id from [OSRR4-G2].[dbo].Models));
